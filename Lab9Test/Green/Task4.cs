...
//    {
//        private Lab9.Green.Task4 _student;
...
//            _output = json.GetProperty("Task4").GetProperty("output").Deserialize<string[][]>();
//        }

//        [TestMethod]
//        public void Test_00_OOP()
//        {
//            var type = typeof(Lab9.Green.Task4);

//            Assert.IsTrue(type.IsClass, "Task4 must be a class");
//            Assert.IsTrue(type.IsSubclassOf(typeof(Lab9.Green.Green)),
//                "Task4 must inherit from Green");
...
//                var actual = _student.Output; // string[]
...
//        {
//            _student = new Lab9.Green.Task4(_input[i]);
//        }
//    }
//}