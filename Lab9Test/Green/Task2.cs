...
//    {
//        private Lab9.Green.Task2 _student;
...
//                var expected = _output[i].Split(", "); // "п, д, в ..." -> ["п","д","в",...]
...
//                {
//                    Assert.AreEqual(expected[j][0], actual[j],
//                        $"Char mismatch\nTest: {i}, Index: {j}\nExpected: {expected[j][0]}\nActual: {actual[j]}");
//                }
//            }
//        }
...
//                var expected = string.Join(", ", _student.Output);
...
//            Assert.IsInstanceOfType(_student.Output, typeof(char[]),
//                $"Output must be of type char[]\nActual type: {_student.Output.GetType()}");
//        }
...
//                var expectedLength = string.Join(", ", _student.Output).Length;
